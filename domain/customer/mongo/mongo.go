...
//mongoCustomer is an internal type that is used to store a CustomerAggregate inside this repo
...
func NewFromCustomer(c aggregate.Customer) mongoCustomer{
	// receives aggregate.Customer and returns mongoCustomer
...
func (m mongoCustomer) ToAggregate() aggregate.Customer{
	// receives mongoCustomer and returns aggregate.Customer
...
//Factory method for MongoRepository
